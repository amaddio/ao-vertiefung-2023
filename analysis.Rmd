...
author: "Amaddio, Patrick, Schimmler, Lin"
date: "2023-06-04"
output:
  pdf_document:
    toc: yes
...
library(readr)
data <- read_delim("data_project_982541_2023_07_03.csv", delim = ";", escape_double = FALSE, trim_ws = TRUE)
...
Manipulation check is significantly higher in the experimental group, t(160) = -6.67, p < .001
...
So far the F(1,161) = 4.18, p = .04 is significant.
